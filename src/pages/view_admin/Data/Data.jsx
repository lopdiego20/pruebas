...
const DashboardData = () => {
  ...
  const eliminarData = async (id) => {
    ...
    let loadingToast;
    try {
      loadingToast = toast.loading('Eliminando análisis...');
                                  ...
                                  <td>
                                    <div className="d-flex gap-2">
                                      ...
                                      >
                                        ...
                                        {detalleVisible === `${item._id}-${field}` ? 'Ocultar' : 'Detalles'}
                                      </Button>
                                      <Button
                                        size="sm"
                                        variant="outline-danger"
                                  ...
                                  <tr>
                                    <td colSpan="4">
                                      <div className="p-3 bg-light">
                                        <h6 className="fw-bold mb-3">Detalles del Análisis - {field}</h6>
                                        <div className="row">
                                          <div className="col-md-6">
                                            <strong>Usuario Comparación:</strong>
                                            <p className="mb-2">{item[field].usercomparasion || 'No especificado'}</p>
                                          </div>
                                          <div className="col-md-6">
                                            <strong>Fecha de Creación:</strong>
                                            <p className="mb-2">{new Date(item.createdAt).toLocaleString()}</p>
                                          </div>
                                          <div className="col-12">
                                            <strong>Descripción Completa:</strong>
                                            <p className="mb-0">{item[field].description || 'Sin descripción disponible'}</p>
                                          </div>
                                        </div>
                                      </div>
                                    </td>
